...
# Description: Modularized build script, breaking down functionalities into specific functions
# Author: Mr K
#
...
# =========================================================================
# Build Process - Other Directories
# =========================================================================
build_other_directories() {
